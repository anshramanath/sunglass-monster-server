...
-- ============================================================
-- Atomic product save RPC (from 006_save_product.sql)
-- ============================================================
...
begin
  ...
  loop
    if v_var->>'id' is null then
      ...
      values (
        p_product_id, v_var->>'sku', v_var->'attribute', (v_var->>'sale')::boolean,
        (v_var->>'regular_price_cents')::int, (v_var->>'sale_price_cents')::int, 0
      )
